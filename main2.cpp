...
struct Studentas {
    ...
    int* paz = nullptr;   // rodykle i pazymiu masyva
...
int ranka() {
    ...
    Studentas* grupe = new Studentas[stud]; // rodykle i studentu masyva

    for (int ii = 0; ii < stud; ii++) {
        Studentas& A = grupe[ii]; // naujas studentas kiekvieną kartą
        int sum = 0;
